...
void Krell::BasicNcurses::create()
{
    initscr();
    clear();
    noecho();
...
void Krell::BasicNcurses::destroy()
{
    endwin();
}
// check if window is running
bool Krell::BasicNcurses::isRunning() const
{
    return _running;
}
// clear screen
void Krell::BasicNcurses::clear()
{
    ::clear();  // Call ncurses clear
}
// render/display
void Krell::BasicNcurses::display()
{
    refresh();
}


void Krell::BasicNcurses::update(const std::vector<std::shared_ptr<IModule>>& modules)
{
    ::clear();
...
void Krell::BasicNcurses::handleEvents()
{
...
std::string Krell::BasicNcurses::getName() const{
    return "BasicNcurses";
}

void Krell::BasicNcurses::run(const std::vector<std::shared_ptr<IModule>>& modules){
    create();
    while (isRunning()) {
        // update modules
